    ...
    <footer className="bg-black text-white w-full">
      <div className="container mx-auto px-4 py-12 w-full">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4 text-red-600">AutoElite</h3>
            <p className="mb-4">Your trusted destination for quality vehicles. We provide a seamless car buying experience with a wide selection of premium cars.</p>
          ...
          {/* Customer Service */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-blue-600">Customer Service</h3>
            <ul className="space-y-2">
              <li>
              ...
              <li>
                <Link href="/financing" className="hover:text-red-600 transition-colors">
                  Financing Options
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                <svg className="w-5 h-5 mt-0.5 mr-2 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <li className="flex items-start">
                ...
                <span>Mon-Fri: 9AM-7PM<br />Sat: 10AM-5PM<br />Sun: Closed</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/20 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <p className="mt-4 md:mt-0">Designed with <span className="text-red-600">❤️</span> for car enthusiasts</p>
        </div>
      </div>
    </footer>
  );
